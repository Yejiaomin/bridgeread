...
const phonemes = [
  ...
  { id: 'y', text: 'yuh.' },
  { id: 'z', text: 'zzz.' },
  // 短元音 — use example words to force correct vowel sound
  { id: 'a_short', text: 'cat. cat. cat.' },
  { id: 'e_short', text: 'bed. bed. bed.' },
  { id: 'i_short', text: 'sit. sit. sit.' },
  { id: 'o_short', text: 'hot. hot. hot.' },
  { id: 'u_short', text: 'cup. cup. cup.' },
  // 长元音
  ...
  { id: 'brilliant',    text: 'Brilliant!',      settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'stunning',     text: 'Stunning!',       settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'perfect',      text: 'Perfect!',        settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'awesome',      text: 'Awesome!',        settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'phenomenal',   text: 'Phenomenal!',     settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'incredible',   text: 'Incredible!',     settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'masterpiece',  text: 'Masterpiece!',    settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  { id: 'exceptional',  text: 'Exceptional!',    settings: { stability: 0.30, similarity_boost: 0.75, style: 0.50, use_speaker_boost: true, speed: 0.85 } },
  // 鼓励音频（答错时）— 最多3词，语速慢
